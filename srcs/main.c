...
/*   Updated: 2020/03/20 11:13:09 by nstabel       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static void			get_transitions(t_mconfig **mconfig)
{
	...
	TRANSITIONS[s_label_graph][SUCCESS] = s_find_paths; // s_move_ants;
	TRANSITIONS[s_find_paths][FAIL] = s_print_error;
	TRANSITIONS[s_find_paths][SUCCESS] = s_move_ants; // s_augment_paths;
